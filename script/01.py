...
filtered_data['temperature'] = filtered_data['temperature'].round(2)

# Step 7: Save the filtered data to a new sheet "Below_25"
with pd.ExcelWriter(file_path, engine='openpyxl', mode='a') as writer:
    filtered_data.to_excel(writer, sheet_name='Below_25', index=False)

print("Filtered data has been saved to 'Below_25' sheet.")
